...
export default function Multiply(props) {
  ...
  const [subTex, setSubTex] = useState("");
  ...
  let temp = "";
  const writeDifference = (matrix1, matrix2) => {
    temp = "";
  ...
  const show = () => {
    setIsOpen(true);
    setSubTex(writeDifference(mat1, mat2));
  };
  ...
  return (
    <div className="container mt-5">
      <MathJax.Provider>
        ...
        >
          <Modal.Header>
            <Modal.Title>Difference of entered matrices is:</Modal.Title>
            <button
              type="button"
              className="btn-close"
